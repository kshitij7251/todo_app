...
ActiveRecord::Schema[8.0].define(version: 2025_10_15_072003) do
  ...
  create_table "subtasks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["parent_task_id"], name: "index_subtasks_on_parent_task_id"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean "overdue_alerts_enabled", default: true
  ...
  add_foreign_key "subtasks", "tasks", column: "parent_task_id"
